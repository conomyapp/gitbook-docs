...
The example below uses `ETPAY` (open banking, Chile). Replace the `origins` node type and sub-object to use a different rail — see the [Nodes page](../payments/origins-and-destinations/README.md) for all available rails.
