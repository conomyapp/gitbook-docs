...
Each `origin` and `destination` must include a `type` field that defines how the funds move. Go to [Payment node page](../../payments/origins-and-destinations/README.md) for more information.
{% endcolumn %}
