...
|---|---|---|---|
| `type` | `string` | Yes | Must be `"ACCOUNT"` |
| `currency` | `string` | Yes | Currency of the account |
| `account.accountNumber` | `string` | Yes | Platform account number |
| `account.identityId` | `string` | No | Identity ID linked to the account |
